          ...
          <div className="flex flex-col gap-3.5">
            {doctors.map((doctor, idx) => (
              <div
                ...
                onMouseEnter={e =>
                  (e.currentTarget.style.boxShadow = "0 8px 32px rgba(12,30,58,0.12)")
                }
                onMouseLeave={e =>
                  (e.currentTarget.style.boxShadow = "0 2px 12px rgba(12,30,58,0.07)")
                }
              >
                <div
                ...
                <div className="flex flex-col items-center gap-2 flex-shrink-0">
                  ...
                  <button
                    ...
                    onMouseEnter={e => (e.currentTarget.style.borderColor = "#0086C3")}
                    onMouseLeave={e => (e.currentTarget.style.borderColor = "rgba(0,134,195,0.35)")}
                  >
                    View Profile
                  </button>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-0.5">
                    <h2
                      className="font-[family-name:var(--font-playfair)] text-[16px] font-bold text-[#0c1e3a] truncate"
                    >
                      {doctor.doctorName}
                    </h2>
                    {doctor.rating && (
                ...
                <div className="flex flex-col gap-2 flex-shrink-0">
                  ...
                  <button
                    ...
                    onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 6px 20px rgba(46,204,113,0.5)")}
                    onMouseLeave={e => (e.currentTarget.style.boxShadow = "0 4px 14px rgba(46,204,113,0.35)")}
                  >
                    📞 Contact Doctor
                  </button>
                </div>
