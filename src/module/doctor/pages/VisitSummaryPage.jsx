  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addVisitSummary(id, {
        notes,
        prescription,
        followUpAfterDays: followUpAfterDays ? Number(followUpAfterDays) : null,
      });
      ...
      >
        ...
        <div className="flex gap-4 pt-4">
          <button
            type="submit"
            disabled={loading}
            className=" bg-linear-to-br from-[#2277f7] to-[#52abd4] text-white px-6 py-2 rounded-lg disabled:opacity-50 cursor-pointer"
          >
